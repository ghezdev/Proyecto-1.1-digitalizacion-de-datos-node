...
{
    const actaCursadas = await pool.query(`SELECT DivCursMatAutoridades.*, DivCursMatAutoridades.titulo, DivCursMatAutoridades.descripcion, DivCursMatAutoridades.cantHoras, dia_horario.dia, dia_horario.entrada,dia_horario.salida,dia_horario.idHorario FROM (SELECT DivCursAutoridades.*, materia.titulo, materia.descripcion, materia.cantHoras
        FROM (
        ...
        INNER JOIN dia_horario ON DivCursMatAutoridades.idCursada = dia_horario.idCursada`)
